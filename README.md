## towr (melodic) - 1.4.1-0

The packages in the `towr` repository were released into the `melodic` distro by running `/usr/bin/bloom-release towr --rosdistro melodic` on `Fri, 05 Apr 2019 16:32:46 -0000`
...
## towr (melodic) - 1.4.0-0

The packages in the `towr` repository were released into the `melodic` distro by running `/usr/bin/bloom-release towr --track melodic --rosdistro melodic` on `Mon, 30 Jul 2018 12:32:00 -0000`
...
The packages in the `towr` repository were released into the `lunar` distro by running `/usr/bin/bloom-release towr --track lunar --rosdistro lunar` on `Mon, 30 Jul 2018 12:28:31 -0000`
...
## towr (kinetic) - 1.4.0-0

The packages in the `towr` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release towr --track kinetic --rosdistro kinetic` on `Mon, 30 Jul 2018 12:24:58 -0000`
...
## towr (melodic) - 1.3.2-0

The packages in the `towr` repository were released into the `melodic` distro by running `/usr/bin/bloom-release towr --track melodic --rosdistro melodic` on `Tue, 17 Jul 2018 16:30:25 -0000`
